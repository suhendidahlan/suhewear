...
const ShopAccessoriesPage = async () => {
  const produk = await getDataByCat("accessories");
  return (
    <>
      <div className="px-8 py-2 text-xl font-bold mt-4">
        ACCESSORIES by SUHE
      </div>
      <FilterStore />
...
export default ShopAccessoriesPage;
