...
const ShopEquipmentsPage = async () => {
  const produk = await getDataByCat("equipments");
  return (
    <>
      <div className="px-8 py-2 text-xl font-bold mt-4">EQUIPMENTS by SUHE</div>
      <FilterStore />
...
export default ShopEquipmentsPage;
